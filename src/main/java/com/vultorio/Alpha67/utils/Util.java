...
public final class Util {
    ...
    public static List<String> ModListId() {
        String[] array = {"Mods World", "STORAGE", "IRONCHEST", "CONSTRUCT", "CYCLIC", "DECORATIVE", "ELEVATOR", "FUZE", "PIPES", "FURNI", "JETPACK", "ENDER", "CREATE", "IMMERSIVE", "MYSTICALAGRICULTURE", "ADDITIONS", "ENVIRON", "THERMAL", "MEKANISM", "RFTOOLS", "SOLARFLUX", "APPLIED", "DRACONIC"};
